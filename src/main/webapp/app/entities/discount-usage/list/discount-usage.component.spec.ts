...
import { sampleWithRequiredData } from '../discount-usage.test-samples';
...
describe('DiscountUsage Management Component', () => {
  let comp: DiscountUsageComponent;
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(DiscountUsageComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.discountUsages?.[0]).toEqual(expect.objectContaining({ id: 'ABC' }));
  });

  describe('trackId', () => {
    it('Should forward to discountUsageService', () => {
      const entity = { id: 'ABC' };
      jest.spyOn(service, 'getDiscountUsageIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDiscountUsageIdentifier).toHaveBeenCalledWith(entity);
